        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header"><i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>Event Requests
                        <div class="btn-actions-pane-right">
                            <div class="nav">
                                <a data-toggle="tab" href="#tab-eg2-0" class="btn-pill btn-wide active btn btn-outline-alternate btn-sm">All Requests</a>
                                <a data-toggle="tab" href="#tab-eg2-1" class="btn-pill btn-wide mr-1 ml-1  btn btn-outline-alternate btn-sm">Returned</a>
                                <a data-toggle="tab" href="#tab-eg2-2" class="btn-pill btn-wide  btn btn-outline-alternate btn-sm">Not Returned</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="tab-pane" id="tab-eg2-1" role="tabpanel">
                                    ...
                                    <table class="mb-0 table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $i = 1;
                                            foreach ($events as $one) { if($one['return_value'] == '1') {?>
                                                <tr>
                                                    <th scope="row"><?php echo $i; ?></th>
                                                    <td class="text-center"><?php echo $one['customerName']; ?> </td>
                                                    <td class="text-center"><a href="tel:"><?php echo $one['phoneNumber']; ?></a> </td>
                                    ...
                                    <div class="tab-pane" id="tab-eg2-2" role="tabpanel">
                                        ...
                                        <table class="mb-0 table table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $i = 1;
                                                foreach ($events as $one) { if($one['return_value'] == '0' || $one['return_value'] == '') { ?>
                                                    <tr>
                                                        <th scope="row"><?php echo $i; ?></th>
                                                        <td class="text-center"><?php echo $one['customerName']; ?> </td>
                                                        <td class="text-center"><a href="tel:"><?php echo $one['phoneNumber']; ?></a> </td>
