<div class="app-main__outer">
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Our Customers
                        <div class="page-title-subheading">Add Customers
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                ...
                <div class="main-card col-md-12 mb-3 card">
                    <div class="card-body">
                      ...
                      <!--   <hr> -->
                        <form class="" action="<?php echo base_url('customers/storeCustomer'); ?>" method="post" enctype="multipart/form-data" >
    ...
    $("#addProd tbody").on("input", ".qty", function () {
