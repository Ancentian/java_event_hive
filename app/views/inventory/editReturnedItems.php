                        ...
                        <div class="card-body">
                            ...
                            <form class="" action="<?php echo base_url('inventory/store_itemsReturned'); ?>" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            <label for="examplePassword11" class="">Event Type</label>
                                            <select class="form-control" name="eventID" required readonly>
                                                <option value="<?php echo $requests['eventID'] ?>"<?php if($requests['evntID'] == $requests['eventID']){echo "selected"; }?>><?php echo $requests['eventName']?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach($items as $key) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="items_returned[]" value="<?php echo $key['items_returned']?>" required>
                                                </td> 
                                                <td>
